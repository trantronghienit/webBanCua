...
$list=$product->product_view($first,$limit);
$total=$product->product_view_count();
?>
 <section>
	<div class="row">
		<div class="col-md-6">
			<h1 class="panel-title">Danh sách sản phẩm</h3>
		</div>
		<div class="col-md-6 text-right">
			<a class="btn btn-primary btn-sm" href="index.php?option=product&cat=insert" role="button">
				<span class="glyphicon glyphicon-plus"></span> Thêm
			</a>
			<a class="btn btn-primary btn-sm" href="index.php?option=product&cat=trash" role="button">
...
<div class="box">
	...
	<div class="box-body">
					...
					<tbody>
						<?php foreach($list as $row): ?>
							...
							<tr>
								...
								<td><img src="../public/imgs/product/<?php echo $row['img']; ?>" style='width: 120px;' class="img-responsive" alt="Image"></td>
								<td><?php echo $row['name']; ?></td>
								<td class="text-center">
								<a href="index.php?option=product&cat=status&id=<?php echo $id;?>">
									<?php if( $row['status']==1): ?>
								...
								<td class="text-center">
									<a class="btn btn-default btn-xs btn-success" style="color: white"  href="index.php?option=product&cat=update&id=<?php echo $id;?>" role="button"><span class="glyphicon glyphicon-pencil"></span>Sửa</a>
								</td>
								<td class="text-center">
									<a class="btn btn-default btn-xs btn-danger" style="color: white"  href="index.php?option=product&cat=deltrash&id=<?php echo $id;?>" role="button">
		...
		<ul class="pagination">
			<?php echo $phantrang->PagePer($total,$current,$limit,'product'); ?>
		</ul>
</div>
