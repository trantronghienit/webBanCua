<?php 
	...
	$list=$product->product_trash($first,$limit);
	$total=$product->product_trash_count();
 ?>
 <section>
	<div class="row">
		<div class="col-md-6">
			<h1 class="panel-title">Thùng rác sản phẩm</h3>
		</div>
		<div class="col-md-6 text-right">
			<a class="btn btn-primary btn-sm" href="index.php?option=product" role="button">
	...
	<div class="box-body">
		<div class="row" style='padding:0px; margin:0px;'>
						...
						<?php foreach($list as $row): ?>
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=product&cat=retrash&id=<?php echo $id;?>" role="button"><span class="glyphicon glyphicon-repeat "></span>Khôi phục</a>
								</td>
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=product&cat=delete&id=<?php echo $id;?>" role="button">
			...
			<div class="row pagination text-center ">			
				<?php echo $pt->PagePer($total, $current, $limit,'product'); ?>
			</div>
		</div>
	</div><!-- ./box-body -->
</div><!-- /.box -->