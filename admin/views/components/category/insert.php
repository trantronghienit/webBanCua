...
?>
<form action="index.php?option=category&cat=proccess" name="form1" method="post">
		...
		<div class="panel-body">
			<div class="col-md-9">
				<div class="form-group">
					...
					<input name="name" type="text" class="form-control" id="" placeholder="Tên loại" required>
				</div>
				<div class="form-group">
