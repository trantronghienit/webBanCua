...
?>
<form action="index.php?option=category&cat=proccess&id=<?php echo $row['id']; ?>" name="form1" method="post">
		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-6 text-right">
					...
					<a class="btn btn-primary btn-smbtn btn-default btn-ms" href="index.php?option=category" role="button">
		...
		<div class="panel-body">
			<div class="col-md-9">
				<div class="form-group">
					...
					<input name="name" type="text" class="form-control" value="<?php echo $row['name']; ?>" id="" placeholder="Tên loại" required>
				</div>
				<div class="form-group">
