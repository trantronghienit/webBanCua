<?php 
	...
	$list=$content->content_trash($first,$limit);
	$total=$content->content_trash_count();
 ?>
 <section>
	<div class="row">
		<div class="col-md-6">
			<h1 class="panel-title">Thùng rác bài viết</h3>
		</div>
		<div class="col-md-6 text-right">
			<a class="btn btn-primary btn-sm" href="index.php?option=content" role="button">
				<span class="glyphicon glyphicon-plus"></span> Thoát
			</a>	
		</div>
</section>
<div class="box">
	...
	<div class="box-body">
		<div class="row" style='padding:0px; margin:0px;'>
				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th style="width: 350px;">Tiêu đề bài viết</th>
						...
						<?php foreach($list as $row): ?>
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=content&cat=retrash&id=<?php echo $id;?>" role="button"><span class="glyphicon glyphicon-repeat "></span>Khôi phục</a>
								</td>
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=content&cat=delete&id=<?php echo $id;?>" role="button">
			...
			<div class="row pagination text-center ">			
				<?php echo $pt->PagePer($total, $current, $limit,'content'); ?>
			</div>
		</div>
	</div><!-- ./box-body -->
</div><!-- /.box -->