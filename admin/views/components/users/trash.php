<?php 
	...
	$list=$users->users_trash($first,$limit);
	$total=$users->users_trash_count();
 ?>
 <section>
	<div class="row">
		<div class="col-md-6">
		...
		<div class="col-md-6 text-right">
			<a class="btn btn-primary btn-sm" href="index.php?option=users" role="button">
	...
	<div class="box-body">
		<div class="row" style='padding:0px; margin:0px;'>
						...
						<?php foreach($list as $row): ?>
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=users&cat=retrash&id=<?php echo $id;?>" role="button"><span class="glyphicon glyphicon-repeat "></span>Khôi phục</a>
								</td>
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=users&cat=delete&id=<?php echo $id;?>" role="button">
			...
			<div class="row pagination text-center ">			
				<?php echo $pt->PagePer($total, $current, $limit,'users'); ?>
			</div>
		</div>
	</div><!-- ./box-body -->
</div><!-- /.box -->