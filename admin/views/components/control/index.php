					...
					<tbody>
						<?php foreach($list as $row): ?>
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=product&cat=update&id=<?php echo $id;?>" role="button"><span class="glyphicon glyphicon-pencil "></span>Sửa</a>
								</td>
								<td class="text-center">
									<a class="btn btn-default btn-xs" href="index.php?option=product&cat=deltrash&id=<?php echo $id;?>" role="button">
