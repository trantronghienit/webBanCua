...
$list=$topic->topic_view($first,$limit);
$total=$topic->topic_view_count();
?>
<section>
  <div class="row">
    <div class="col-md-6">
      <h1 class="panel-title">Danh sách chủ đề bài viết</h3>
		</div>
		<div class="col-md-6 text-right">
			<a class="btn btn-primary btn-sm" href="index.php?option=topic&cat=insert" role="button">
				<span class="glyphicon glyphicon-plus"></span> Thêm mới
			</a>
			<a class="btn btn-primary btn-sm" href="index.php?option=topic&cat=trash" role="button">
...
<div class="box">
	...
	<div class="box-body">
				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th>Tên loại chủ đề bài viết</th>
					...
					<tbody>
						<?php foreach($list as $row): ?>
							...
							<tr>
								...
								<a href="index.php?option=topic&cat=status&id=<?php echo $id;?>">
									<?php if( $row['status']==1): ?>
								...
								<td class="text-center">
									<a class="btn btn-default btn-xs btn-success" style="color: white"  href="index.php?option=topic&cat=update&id=<?php echo $id;?>" role="button"><span class="glyphicon glyphicon-pencil "></span>Sửa</a>
								</td>
								<td class="text-center">
									<a class="btn btn-default btn-xs btn-danger" style="color: white"  href="index.php?option=topic&cat=deltrash&id=<?php echo $id;?>" role="button">
		...
		<ul class="pagination">
			<?php echo $phantrang->PagePer($total,$current,$limit,'topic'); ?>
		</ul>
</div>
